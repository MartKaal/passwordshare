...
export default function Share() {
    ...
    const handleCopy = () => {
        switch (mode) {
            ...
            case 'opened':
                if (receivedPassword) {
                    navigator.clipboard.writeText(receivedPassword);
                }
                break;
        }
    };
        ...
        <>
            {mode === 'input' && (
                ...
                >
                    ...
                    <button
                        type="button"
                        className="me-2 mb-2 rounded-lg bg-violet-600 px-5 py-2.5 text-sm font-medium text-white hover:cursor-pointer hover:bg-violet-700 focus:ring-1 focus:outline-none"
            ...
            {mode === 'generated' && (
                <PasswordTool title="Uw link is gegenereerd!" subtitle="De link is geldig voor 24 uur en kan eenmalig gebruikt worden.">
                    ...
                    <button
                        type="button"
                        className="rounded-lg bg-violet-600 px-5 py-2.5 text-sm font-medium text-white hover:cursor-pointer hover:bg-violet-700 focus:ring-1"
                        onClick={handleCopy}
                    >
